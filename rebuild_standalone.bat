...
pyinstaller --onefile --windowed --icon=ag_logo.ico --add-data "templates;templates" --add-data "static;static" --name "POS System" --hidden-import=psutil pos_launcher.py
